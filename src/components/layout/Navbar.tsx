      ...
      >
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          >
            ...
            <div className={cn('flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground border-0', site.companyLogo && !site.companyLogo.includes('placeholder') && 'hidden')}>
        ...
        >
          <SheetHeader className="mb-6">
            <SheetTitle className="flex items-center gap-2">
              ...
              <div className={cn('flex h-9 w-9 items-center justify-center rounded-full bg-primary text-primary-foreground border-0', site.companyLogo && !site.companyLogo.includes('placeholder') && 'hidden')}>
